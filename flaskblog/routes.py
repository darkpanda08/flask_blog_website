...
def register():
    if current_user.is_authenticated:
        flash('You are already logged in. Logout to register.', 'success')
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender=('Flask Blog', os.environ.get('SENDER_EMAIL')),
                  recipients=[user.email], reply_to=os.environ.get('REPLY_EMAIL'))
